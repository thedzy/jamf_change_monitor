...
"""
Script:	diskencryptionconfigurations.py
Date:	2020-01-10
Platform: macOS/Linux
Description:
Retrieves and processes /JSSResource/diskencryptionconfigurations
"""
__author__ = 'thedzy'
...
def get_name(json_data):
    ...
    name = json_data['disk_encryption_configuration']['name']
