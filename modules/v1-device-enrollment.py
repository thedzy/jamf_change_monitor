...
"""
Script:	v1-device-enrollment.py
Date:	2020-01-10
Platform: macOS/Linux
Description:
Retrieves and processes /uapi/v1/device-enrollments
"""
__author__ = 'thedzy'
...
def get(api_classic=None, api_universal=None):
    ...
    api_query = api_universal.get_data('v1', 'device-enrollment', page=0, size=25, sort='id:desc')
