...
"""
Script:	enrollment-customizations.py
Date:	2021-12-07
Platform: macOS/Linux
Description:
Retrieves and processes /v2/enrollment-customizations
"""
__author__ = 'thedzy'
...
def get(api_classic=None, api_universal=None, repo_path=None):
    ...
    while remainder > 0:
        api_query = api_universal.get_data('v2', 'enrollment-customizations', page=page, size=size, sort='id:desc')
