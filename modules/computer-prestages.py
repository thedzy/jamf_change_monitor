...
"""
Script:	computer-prestages.py
Date:	2020-01-10
Platform: macOS/Linux
Description:
Retrieves and processes /v1/computer-prestages
"""
__author__ = 'thedzy'
...
def get(api_classic=None, api_universal=None, repo_path=None):
    ...
    # Query api
    api_query = api_universal.get_data('v2', 'computer-prestages', page=0, size=25, sort='id:desc')
